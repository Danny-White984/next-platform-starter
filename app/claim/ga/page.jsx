...
export default function GAClaimPage() {
        ...
        <div className="flex flex-col gap-8 items-center">
            <section className="text-center py-8">
                ...
                <h1 className="mb-4 text-4xl sm:text-5xl">
                    Claim Your Free GA Item!
                </h1>
                <p className="text-xl text-neutral-300 max-w-xl mx-auto">
                    Enter your message below and we'll get back to you about your free item from the GA!
                </p>
            </section>
                ...
                <div className="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-xl p-8 shadow-lg">
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        <textarea
                            ...
                            required
                            rows={4}
                            className="w-full px-4 py-3 rounded-lg bg-white/90 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-300 resize-none"
                            disabled={status === 'pending'}
                        />
                        <button
                            type="submit"
                            disabled={status === 'pending'}
                            className="w-full py-3 px-6 bg-white text-purple-600 font-bold rounded-lg hover:bg-purple-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
